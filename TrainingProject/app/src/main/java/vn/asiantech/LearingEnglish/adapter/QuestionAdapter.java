...
public class QuestionAdapter extends RecyclerView.Adapter<QuestionAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        FunctionModel.changeTextViewToTwoColor(holder.tvQuestionNumber, "Test " + pos + ":  ", mNumberTestings.get(position).getLevel() + " - " + mNumberTestings.get(position).getTime(), Color.BLUE, Color.BLACK);
    }
